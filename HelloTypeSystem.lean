...
- ML言語の評価導出システムと型システム
  ...
  - [ML2](./HelloTypeSystem/ML2.html)：定義、変数束縛と環境 \[基礎概念,4章]
    ...
    - TypingML2による型安全性 `HelloTypeSystem.ML2.type_safety`
...
- 大堀淳の計算機科学チャネル. コンパイラ ー原理と構造ー \[Video]. YouTube. [https://www.youtube.com/playlist?list=PLp1bKoc7XHdQwbHaUzMryG6WpnN4JdR6P](https://www.youtube.com/playlist?list=PLp1bKoc7XHdQwbHaUzMryG6WpnN4JdR6P)
- J.ホップクロフト, R.モトワニ, J.ウルマン 共著ほか. オートマトン言語理論計算論 1. 第2版, サイエンス社, 2003.4, (Information & computing ; 3). 4-7819-1026-2. [https://ndlsearch.ndl.go.jp/books/R100000002-I000004074939](https://ndlsearch.ndl.go.jp/books/R100000002-I000004074939)
-/
